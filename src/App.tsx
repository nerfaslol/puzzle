import { PuzzleGenerator } from "@/components/puzzle-generator"
    ...
    <div className="min-h-svh bg-muted/30">
      <header className="border-b bg-background">
        <div className="mx-auto flex max-w-6xl items-center gap-3 px-4 py-4 md:px-8">
          ...
          <div>
            <h1 className="text-base font-semibold leading-tight">Gerador de Quebra-Cabeça</h1>
            <p className="text-sm text-muted-foreground">Padrões de corte a laser em SVG</p>
          </div>
        </div>
      </header>
